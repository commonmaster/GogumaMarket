	...
	<section>
		<div class="my_container">
			<div class="content">
				<!--  여기부터 작성하시면 될듯 -->
				<div id="tablebox">
					<form onsubmit="return submit_check()" action ="/product_update"  method="post" enctype="multipart/form-data">
					<input type="hidden" name="pno" value="${product.pno}">
					<input type="hidden" name="imgChange" value="0" id="imgChange">
					<table>
						<tr>
							
						</tr>
						<tr>
							<th><img src="/picture/${product.pno}" id="picture" alt="물품사진" onclick="document.getElementById('picturefile').click();"><br>
						...
						<tr>
							<td id="title_tit"><input type="text" id="title" name="title" placeholder="제목(최대 25자)" maxlength="25" autocomplete="off" value="${product.title}"></td>
						<tr>
						<tr>
							<td class="table_space_line"></td>
						</tr>
						<tr>
							<td id="price_tit"><span id="won">￦</span><input type="number" id="price"	name="price" placeholder="가격" autocomplete="off" maxlength="9" onblur="numberMaxLength(this);" value="${product.price}"></td>
						</tr>
						<tr>
							<td class="table_space_line"></td>
						</tr>
						<tr>
							<td><textarea id="contents" name="contents" placeholder="수정할 제품 소개글을 입력해주세요.">${product.contents}</textarea></td>
						</tr>
						<tr>
							<td class="table_space_line"></td>
						</tr>
						<tr><td id="address_tit">
							<input type="text" id="sample5_address" placeholder="주소" readonly="readonly" name="address" value="${product.address}">
						...
						<tr>
							<td><input type="hidden" name="latitude" id="latitude" value="${product.latitude}"></td>
						</tr>
						
						<tr>
							<td><input type="hidden" name="longitude" id="longitude" value="${product.longitude}"></td>
						</tr>
						<tr>
							<td><b><input type="submit" value="변경"	id="product_update_btn"></b></td>
						</tr>
					</table>
					</form>
				</div>
...
function submit_check(){
	...
	return title_check() && price_check() && contents_check();
}
...
mapOption = {
    center: new daum.maps.LatLng(${product.latitude}, ${product.longitude}), // 지도의 중심좌표
    level: 3 // 지도의 확대 레벨
};
...
position: new daum.maps.LatLng(${product.latitude}, ${product.longitude}),
map: map
});
